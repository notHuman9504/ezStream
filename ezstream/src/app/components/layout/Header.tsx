            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive && item.name === 'Logout' && "bg-red-500/10 text-red-400",
                  isActive && (item.name === 'Sign In' || item.name === 'Sign Up') && "bg-green-500/10 text-green-400",
                  isActive && !['Logout', 'Sign In', 'Sign Up'].includes(item.name) && "bg-white/10 text-white"
                )}
              >
                ...
                {isActive && (
                  <motion.div
                    ...
                    className={cn(
                      ...
                      (item.name === 'Sign In' || item.name === 'Sign Up') && "bg-green-400/5",
                      !['Logout', 'Sign In', 'Sign Up'].includes(item.name) && "bg-white/5"
                    )}
                    initial={false}
                    transition={{
                      type: "spring",
                  ...
                  >
                    <div className={cn(
                      ...
                      (item.name === 'Sign In' || item.name === 'Sign Up') && "bg-green-400",
                      !['Logout', 'Sign In', 'Sign Up'].includes(item.name) && "bg-white"
                    )}>
                      <div className={cn(
                        "absolute w-12 h-6 rounded-full blur-md -top-2 -left-2",
                        item.name === 'Logout' && "bg-red-400/20",
                        (item.name === 'Sign In' || item.name === 'Sign Up') && "bg-green-400/20",
                        !['Logout', 'Sign In', 'Sign Up'].includes(item.name) && "bg-white/20"
                      )} />
                      <div className={cn(
