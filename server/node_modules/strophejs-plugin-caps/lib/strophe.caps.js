(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('strophe.js'), require('strophejs-plugin-disco')) :
	typeof define === 'function' && define.amd ? define(['strophe.js', 'strophejs-plugin-disco'], factory) :
	(factory(global.window));
}(this, (function (strophe_js) { 'use strict';

strophe_js.Strophe.addConnectionPlugin('caps', {
	/** Constant: HASH
	 * Hash used
	 *
	...
	init: function(conn) {
		...
		strophe_js.Strophe.addNamespace('CAPS', 'http://jabber.org/protocol/caps');

		if (!this._connection.disco) {
			throw "Caps plugin requires the disco plugin to be installed.";
		}

		this._connection.disco.addFeature(strophe_js.Strophe.NS.CAPS);
		this._connection.addHandler(this._delegateCapabilities.bind(this), strophe_js.Strophe.NS.CAPS);
	},
	...
	generateCapsAttrs: function() {
		return {
			'xmlns': strophe_js.Strophe.NS.CAPS,
			'hash': this.HASH,
			'node': this.node,
	...
	generateVer: function() {
		...
		this._ver = strophe_js.b64_sha1(ver);
		return this._ver;
	},
	...
	_requestCapabilities: function(to, node, ver) {
		if (to !== this._connection.jid) {
			...
			this._connection.addHandler(this._handleDiscoInfoReply.bind(this), strophe_js.Strophe.NS.DISCO_INFO, 'iq', 'result', id, to);
		}
		return true;
	},
...
//# sourceMappingURL=strophe.caps.js.map
